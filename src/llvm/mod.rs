...
impl LLVMCompiler {
    ...
    fn build(&self, ops: &[Op]) -> anyhow::Result<()> {
        unsafe {
            ...
            let entry =
                ffi::LLVMAppendBasicBlockInContext(self.context, main_fn, entry_name.as_ptr());
